...
func NewBlogService(blogRepo *repository.BlogRepository, userRepo *repository.UserRepository, roleRepo *repository.RoleRepository) *BlogService {
	return &BlogService{
		blogRepo: blogRepo,
		userRepo: userRepo,
		roleRepo: roleRepo,
...
func (s *BlogService) Create(authorID uuid.UUID, req CreateBlogRequest) (*models.Blog, error) {
	if req.Title == "" {
...
func (s *BlogService) Update(blogID uuid.UUID, userID uuid.UUID, userRoles []string, req UpdateBlogRequest) (*models.Blog, error) {
...
func (s *BlogService) List(offset, limit int) ([]models.Blog, int64, error) {
...
func (s *BlogService) ListByAuthor(authorID uuid.UUID, offset, limit int) ([]models.Blog, int64, error) {
