...
type BaseRoleHandler[TRole core.RoleInterface] struct {
	roleService *service.BaseRoleService[TRole]
}

// NewBaseRoleHandler tạo mới BaseRoleHandler với generic type
func NewBaseRoleHandler[TRole core.RoleInterface](
	roleService *service.BaseRoleService[TRole],
) *BaseRoleHandler[TRole] {
	return &BaseRoleHandler[TRole]{roleService: roleService}
}

// AddRole handles add role request
// POST /api/roles
func (h *BaseRoleHandler[TRole]) AddRole(c *fiber.Ctx) error {
...
// DELETE /api/roles/:id
func (h *BaseRoleHandler[TRole]) RemoveRole(c *fiber.Ctx) error {
...
// GET /api/roles
func (h *BaseRoleHandler[TRole]) ListRoles(c *fiber.Ctx) error {
...
func (h *BaseRoleHandler[TRole]) AddRoleToUser(c *fiber.Ctx) error {
...
func (h *BaseRoleHandler[TRole]) RemoveRoleFromUser(c *fiber.Ctx) error {
	userID := c.Params("user_id")
	if userID == "" {
		return goerrorkit.NewValidationError("User ID không hợp lệ", map[string]interface{}{
			"user_id": c.Params("user_id"),
...
func (h *BaseRoleHandler[TRole]) CheckUserHasRole(c *fiber.Ctx) error {
	userID := c.Params("user_id")
	if userID == "" {
		return goerrorkit.NewValidationError("User ID không hợp lệ", map[string]interface{}{
			"user_id": c.Params("user_id"),
...
func (h *BaseRoleHandler[TRole]) ListRolesOfUser(c *fiber.Ctx) error {
	userID := c.Params("user_id")
	if userID == "" {
		return goerrorkit.NewValidationError("User ID không hợp lệ", map[string]interface{}{
			"user_id": c.Params("user_id"),
...
func (h *BaseRoleHandler[TRole]) ListUsersHasRole(c *fiber.Ctx) error {
	roleName := c.Params("role_name")
	if roleName == "" {
		return goerrorkit.NewValidationError("Role name là bắt buộc", map[string]interface{}{
			"field": "role_name",
